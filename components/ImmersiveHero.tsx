...
export function ImmersiveHero() {
  ...
  const style = (depth: number) => ({ transform: `translate3d(${pointer.x * depth}px, ${pointer.y * depth}px, 0)` });

  return (
    <section className="hero hero-immersive" ref={ref}>
      <div className="hero-noise" aria-hidden="true" />
      <div className="hero-media hero-layer-back" style={style(-7)}>
        <Image src={HERO_IMAGE} alt="Z-Clothes campaign" fill priority sizes="100vw" quality={85} />
      </div>
      ...
      <div className="hero-copy hero-layer-front" style={style(5)}>
        ...
        <div className="hero-actions">
          ...
          <Link href="/about" className="story-link">Discover our story <ArrowUpRight/></Link>
        </div>
      </div>
