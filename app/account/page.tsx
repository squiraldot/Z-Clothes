...
export default async function AccountPage() {
  ...
  return <main className="account-page"><div className="account-shell">
    ...
    <div className="account-grid">
      ...
      <section className="account-panel"><span className="eyebrow dark">ORDERS</span><h2>Your orders stay here.</h2><p>Your account can now save order drafts securely. Full order history and delivery tracking will be connected in the next account phase.</p><Link href="/checkout" className="btn light account-link">Open bag</Link></section>
