...
export default async function AccountPage() {
  ...
  return <main className="account-page account-v2"><div className="account-shell">
    ...
    <div className="account-v2-grid">
      ...
      <section className="account-panel account-recent-orders"><div className="account-panel-top"><div><span className="eyebrow dark">RECENT ORDERS</span><h2>Your latest pieces.</h2></div><Link className="account-view-all" href="/account/orders"><span>View all orders</span><ArrowRight size={15}/></Link></div>
