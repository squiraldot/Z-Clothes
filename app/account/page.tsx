...
export default async function AccountPage() {
  ...
  return <main className="account-page"><div className="account-shell">
    ...
    <div className="account-grid">
      ...
      <section className="account-panel"><span className="eyebrow dark">SHOPPING</span><h2>Your wishlist stays close.</h2><p>Your saved pieces stay connected to your account while you browse the collection.</p><Link href="/wishlist" className="btn light account-link">Open wishlist</Link></section>
      <section className="account-panel"><span className="eyebrow dark">DELIVERY</span><h2>Keep your addresses ready.</h2><p>Save home, work or other delivery addresses so checkout stays quick and simple.</p><Link href="/account/addresses" className="btn light account-link">Manage addresses</Link></section>
      <section className="account-panel"><span className="eyebrow dark">ORDERS</span><h2>Your orders stay here.</h2><p>See your saved orders, order status, totals and the pieces included in each order.</p><Link href="/account/orders" className="btn light account-link">View orders</Link></section>
