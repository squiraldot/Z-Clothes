...
export default async function Home() {
  ...
  return <main>
    ...
    <section className="section"><div className="section-head"><div><span className="eyebrow dark">THE LATEST EDIT</span><h2>Featured Products</h2></div><Link href="/products" className="text-link">View all →</Link></div><div className="featured-products-rail"><HorizontalRail products={products.slice(0,8)}/></div></section>
